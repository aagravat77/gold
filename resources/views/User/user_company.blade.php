        ...
        <div class="container">
            <div class="row justify-content-center ">
                <div class="col-lg-4 col-md-6 col-sm-8 col-xs-12 ">
                    <form class="form-container bg-light" enctype="multipart/form-data" method="POST" action="{{ route('user.party_detail') }}">
                        @csrf
                        <center>
                        ...
                        <div class="mb-3 ">
                            ...
                            <input id="party_name" type="text" class="form-control @error('party_name') is-invalid @enderror"
                                name="party_name" value="{{ old('party_name') }}"  autofocus>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="license_image" type="file" class="form-control @error('license_image') is-invalid @enderror"
                                name="license_image" value="{{ old('license_image') }}"  autofocus>
                        ...
                        <div class="mb-3 ">
                            ...
                            <input id="party_logo" type="file" class="form-control @error('party_logo') is-invalid @enderror"
                                name="party_logo" value="{{ old('party_logo') }}"  autofocus>
