                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8 col-xs-12 ">
                        <form class="form-container bg-light" enctype="multipart/form-data" method="POST"
                            ...
                            <div class="mb-3 ">
                                ...
                                <input id="item_name" type="text" value="{{ $data->item_name }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input id="item_price" type="number" value="{{ $data->item_price }}"
                            ...
                            <div class="mb-3 ">
                                ...
                                <input id="item_quantity" type="number" value="{{ $data->item_quantity }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="item_image" value="{{ $data->item_id }}"
                             ...
                             <center>
                                          <img src="{{ asset('public/order_item_image/' . $data->item_image) }}"width="120px"
